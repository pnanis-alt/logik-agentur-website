...
| 31 | 🟡 Rechtschreibung und Typografie | **erledigt 03.08.2026** | Die Audit-Liste mit ca. 25 Einzelpunkten lag nie vor, deshalb eigener Durchgang über alle fünf Seiten. Gefunden und korrigiert: Abkürzungen `z.B.`/`i.d.R.` ohne geschütztes Leerzeichen (9 Stellen), zwölf Anglizismen und Uneinheitlichkeiten im Modul-Raster, das nie Zeile für Zeile geprüft worden war (After-Hours, Booking-Links, FAQs, Pitch-Deck, „vor Posten", „markenkonform"), „Mehrsprachig" gegen die Entscheidung zu Punkt 22, „Reservierungen" gegen die Abgrenzung aus Punkt 21, „Onboarding-Formular" gegen „Fragenkatalog", Genitiv „des Agents". Zusätzlich Produktname **Termin-Booking → Termin-Buchung** in Website und AGB, und der englische Zusatz „(IP-Buyout)" aus AGB § 14. Vermeintliche Leerzeichenfehler waren durchweg Artefakte der Textextraktion, im Quelltext korrekt. |
